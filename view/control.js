...
function ManageModuleAdd() {
  ...
  let lz = document.getElementById("lzA").value;
  ...
  if (lx === "" || ly === "" || lz === "") {
    alert("Enter Valid position (values must not be empty)");
    return false;
  }
...
function ManageModuleModify() {
  ...
  let lz = document.getElementById("lzM").value;
  let test = false;
...
function ManageCountryAdd() {
  ...
  let lz = document.getElementById("lzCA").value;
...
function ManageCountryModify() {
  ...
  let lz = document.getElementById("lzCM").value;
